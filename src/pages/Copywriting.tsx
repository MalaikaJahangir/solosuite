          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                  <h3 className="text-xl font-semibold text-slate-900 mb-3">📝 Conversion-Focused Messaging</h3>
                  <p className="text-gray-600">Content crafted with intent, guiding audiences from interest to action.</p>
                </div>
                
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                  <h3 className="text-xl font-semibold text-slate-900 mb-3">🔄 Funnel Integration</h3>
                  <p className="text-gray-600">Seamless alignment between content, lead capture, and offers.</p>
                </div>
                
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                  <h3 className="text-xl font-semibold text-slate-900 mb-3">📊 Performance-Driven Optimization</h3>
            ...
            <div className="lg:sticky lg:top-32 lg:self-start">
              ...
              <div className="mt-8 bg-slate-50 border border-slate-100 p-8 rounded-3xl">
                <h3 className="text-xl font-bold text-slate-900 mb-4 tracking-tight">Need a Clear Content Framework?</h3>
