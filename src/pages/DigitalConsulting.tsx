                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 mb-8">
                                <div className="bg-white p-6 rounded-2xl shadow-sm">
                                    <h3 className="text-xl font-semibold text-slate-900 mb-3">📊 CRM Architecture</h3>
                                    <p className="text-gray-600">Organized lead management systems for clarity and tracking.</p>
                                </div>

                                <div className="bg-white p-6 rounded-2xl shadow-sm">
                                    <h3 className="text-xl font-semibold text-slate-900 mb-3">📈 Pipeline Optimization</h3>
                                    <p className="text-gray-600">Structured sales flows that improve follow-up and close rates.</p>
                                </div>

                                <div className="bg-white p-6 rounded-2xl shadow-sm">
                                    <h3 className="text-xl font-semibold text-slate-900 mb-3">🔍 Performance Visibility</h3>
                        ...
                        <div className="lg:sticky lg:top-32 lg:self-start">
                            ...
                            <div className="mt-8 bg-slate-50 border border-slate-100 p-8 rounded-3xl">
                                <h3 className="text-xl font-bold text-slate-900 mb-4 tracking-tight">Need Sales & Operational Clarity?</h3>
