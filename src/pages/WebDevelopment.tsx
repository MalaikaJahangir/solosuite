                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 mb-8">
                                <div className="bg-white p-6 rounded-2xl shadow-sm">
                                    <h3 className="text-xl font-semibold text-slate-900 mb-3">🚀 Conversion-Focused Architecture</h3>
                                ...
                                <div className="bg-white p-6 rounded-2xl shadow-sm">
                                    <h3 className="text-xl font-semibold text-slate-900 mb-3">📱 Responsive & Scalable Design</h3>
                                ...
                                <div className="bg-white p-6 rounded-2xl shadow-sm">
                                    <h3 className="text-xl font-semibold text-slate-900 mb-3">⚙️ Performance & Reliability</h3>
                            ...
                            {/* Projects Carousel */}
                            <div>
                                <h3 className="text-2xl font-bold text-slate-900 mb-6 tracking-tight">Real-World Projects</h3>
                        ...
                        <div className="lg:sticky lg:top-32 lg:self-start">
                            ...
                            <div className="mt-8 bg-slate-50 border border-slate-100 p-8 rounded-3xl">
                                <h3 className="text-xl font-bold text-slate-900 mb-4 tracking-tight">Need Complete Digital Solutions?</h3>
